...
set_property PACKAGE_PIN W17 [get_ports {dividend[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {dividend[0]}]
set_property PACKAGE_PIN W15 [get_ports {dividend[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {dividend[1]}]
set_property PACKAGE_PIN V15 [get_ports {dividend[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {dividend[2]}]
set_property PACKAGE_PIN W14 [get_ports {dividend[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {dividend[3]}]
set_property PACKAGE_PIN W13 [get_ports {dividend[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {dividend[4]}]
set_property PACKAGE_PIN V2 [get_ports {dividend[5]}]
...
set_property PACKAGE_PIN U14 [get_ports {ready}]
